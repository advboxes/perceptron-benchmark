...
class ClsAdversarial(Adversarial):
    ...
    def __init__(
        ...
        super(ClsAdversarial, self).__init__(
            model,
            criterion,
            original_image,
            original_pred,
    ...
    def predictions_and_gradient(
        ...
        predictions, gradient = \
            self._model.predictions_and_gradient(image, label)
    ...
    def backward(self, gradient, image=None, strict=True):
        ...
        self._total_gradient_calls += 1
        gradient = self._model.backward(gradient, image)
